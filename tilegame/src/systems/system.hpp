...
namespace tilegame::systems
{
    ...
    protected:
        ...
        void raise_events()
        {
            const auto event_view = _registry.view<Event>(entt::exclude<components::Inactive>);
            const auto listener_view = _registry.view<EventListener>(entt::exclude<components::Inactive>);
